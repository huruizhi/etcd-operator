...
import (
	...
	appv1beta1 "etcd-operator/api/v1beta1"
)
...
// +kubebuilder:rbac:groups=app.etcdCluster.cn,resources=etcdrestores,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=app.etcdCluster.cn,resources=etcdrestores/status,verbs=get;update;patch
