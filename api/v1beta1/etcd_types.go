...
var (
	staticInitType        InitClusterType = "static"
	DnsInitType           InitClusterType = "dns"
	etcdDiscoveryInitType InitClusterType = "etcdDiscovery"
)
...
type EtcdSpec struct {
	...
	ClusterType InitClusterType `json:"cluster_type"`
}
